...
=\frac{1}{2m_0\mu}\coth\left(-\frac{1}{2}\mu T\right)
...
We also know from the law of large numbers that the squared sampling error is proportional of the variance $V$ of the quantity of interest and decrases linearly with the number of samples $N$
\begin{equation}
