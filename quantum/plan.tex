...
\begin{equation}
  \text{(finite volume error)} \propto \exp\left[-m_\pi L\right]
\end{equation}
where $L$ is the size of the simulation box and $m_\pi$ is the mass of the lightest hardron \cite{Lepage1994}.
