...
\end{equation}
This integral is solved exactly for the quantum mechanical harmonic oscillator $V(x)=\frac{1}{2}\mu^2 x^2$ in \cite{Creutz1981} (see also appendix \ref{sec:harmonic_oscillator}), i.e. in this case we know the bias (and also any finite volume errors).
