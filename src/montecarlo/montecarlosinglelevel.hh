...
public:
  ...
  SingleLevelMCParameters()
      : Parameters("singlelevelmc"), n_burnin_(100), epsilon_(1.0),
        sampler_(SamplerHMC) {
...
public:
  ...
  double numerical_result() const { return stats_Q->average(); }

  /** @brief Return statistical error */
  double statistical_error() const { return stats_Q->error(); }
